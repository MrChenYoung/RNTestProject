...
import {
    View, Picker, StyleSheet, Dimensions, TouchableOpacity, Alert, Text, Platform
} from 'react-native';
...
class PickerData extends PureComponent {
    ...
    comfig = () => {
        ...
        let year=this.state.datetimeYear;
        let month=this.state.datetimeMoth;
        ...
        if (yeartime < yeartimeer) {
            ...
            // 回调
            this.props.onComfig(year,month);
        }
    };
    //     <Modal
    //     animationType='none'
    ...
    getMainView(show){
        ...
        if(show){
          mainView = <View style={styles.modelSelect}>
            <View style={styles.ViewStyle}>
              ...
              <View style={styles.main}>
                ...
                >
                  {this._renderDeal(dataObj.getFullYear() - 4, dataObj.getFullYear() + 1, '年')}
                </Picker>
                <Picker
                  prompt={'请选择月份'}
                  mode="dialog"
...
const styles = StyleSheet.create({
    ...
    ViewStyle: {
        ...
        alignSelf: 'center',
        height: (Platform.OS === 'android' ? 240 : 300),
        // height: 240,
        justifyContent: 'center',
        borderRadius: 10,
        marginHorizontal: 15,
